...
while IFS= read -r path; do
  case "$path" in
    .gitignore|README.md|LICENSE|CHANGELOG.md|CONTRIBUTING.md|SECURITY.md|PUBLICATION.md|core/*|templates/*|docs/*|projects/learning/*|scripts/public-safety-check.*|.github/*|.github/**/*)
      ;;
    *)
